...
namespace CT.BUS
{
    public class ChiTietUserBUS
    {
       
        public BaseResultMOD CNChiTietUser(CapNhatChiTietUserMOD item, IFormFile file)
        {
            ...
            try
            {
                ...
                {
                    return new ChiTietUserDAL().CapNhatChiTietUser(item, file);
                }
        ...
        public BaseResultMOD DanhSachUsers(int page )
...

        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Result = new ChiTietUserDAL().getDSChiTietUser(page);
